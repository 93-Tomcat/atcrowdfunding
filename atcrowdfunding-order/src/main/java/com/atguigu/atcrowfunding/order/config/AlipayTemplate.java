package com.atguigu.atcrowfunding.order.config;
...
public class AlipayTemplate {
    ...
    private String notify_url = "http://xb6cg22x28.52http.net/payAsync";

    // 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
    //同步通知，支付成功，一般跳转到成功页
    private String return_url = "http://xb6cg22x28.52http.net/orderList";
    ...
    public String pay(PayVo vo) throws AlipayApiException {
        System.out.println("秘钥："+merchant_private_key);
